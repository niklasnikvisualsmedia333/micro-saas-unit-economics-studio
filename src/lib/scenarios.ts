...
export function scenarioTemplates(): Scenario[] {
  ...
  return [
    ...
    {
      ...base,
      id: "template-trustmrr-inspired",
      name: "Verified Revenue Deal Scout",
      description: "TrustMRR-inspired revenue intelligence for founders browsing verified micro-SaaS listings and deal comps.",
      monthlyVisitors: 9000,
      ...
      targetMRR: 7000,
      targetARR: 120000,
      fixedMonthlyCosts: 620,
      variableCostPerPaidUser: 2.4,
      variableCostPerFreeUser: 0.12,
      aiFeatures: [ai("template-trustmrr-feature", "Listing and revenue comp summarizer", 3, 45)],
    },
    {
      ...base,
